...
for (k in 1:10) {
    ...
    formula <- as.formula("avg_Log10_NoV ~ lockdown_step3 + lockdown_step4 + lockdown_planB +
    ...
    rain_2 + rain_3 + rain_4 + rain_5+ site_code + week")
...
write.csv(metrics, "../../output/ML_rf_model_metrics_full_final.csv")
write.csv(predictions, "../../output/ML_rf_model_predictions_full_final.csv")
