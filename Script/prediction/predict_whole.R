...
dp_final$pred_mean <_ fit.summary.fitted.values[index, "mean"]
dp_final$pred_ll <- fit.summary.fitted.values[index, "0.025qyant"]
dp_final$pred_ul <- fit.summary.fitted.values[index, "0.975qyant"]
