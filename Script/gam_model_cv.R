...
write.csv(metrics, "outputs/ML_model/cv/ML_gam_model_metrics_full_final.csv")
write.csv(predictions, "outputs/ML_model/cv/ML_gam_model_predictions_full_final.csv")